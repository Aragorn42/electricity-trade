...
if __name__ == "__main__":
    ...
    parser.add_argument('--file_path', type=str, default='/home/liym/code/ElectricityTrade/electricity-trade/dataset/日前实时套利计算before.xlsm', help='Path to the Excel file')
