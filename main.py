...
parser.add_argument('--train_start_day', type=str)
parser.add_argument('--train_end_day', type=str)
parser.add_argument('--eval_start_day', type=str)
parser.add_argument('--eval_end_day', type=str)
parser.add_argument('--val_start_day', type=str)
parser.add_argument('--val_end_day', type=str)
